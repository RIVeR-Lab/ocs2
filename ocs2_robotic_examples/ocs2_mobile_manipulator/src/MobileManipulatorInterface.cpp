...
namespace ocs2
{
  namespace mobile_manipulator
  {
          ...
          modelModeIntQuery_(initModelModeInt)
    {
      ...
      rosReferenceManagerPtr_ = std::make_shared<ocs2::RosReferenceManager>(robotModelName_, referenceManagerPtr_);
      ...
      */
      ...
      quadraticInputCostPtr_mode2_ = std::move(getQuadraticInputCost());
    ...
    void MobileManipulatorInterface::setMPCProblem(bool iterFlag)
    {
      ...
      */
      ...
      {
        mpcTimer3_.startTimer();
        ocp_.costPtr->add("inputCost", std::move(quadraticInputCostPtr_mode0_));
        mpcTimer3_.endTimer();

        mpcTimer4_.startTimer();
        ocp_.softConstraintPtr->add("jointLimits", std::move(jointLimitSoftConstraintPtr_mode0_));
        mpcTimer4_.endTimer();

        mpcTimer5_.startTimer();
        ocp_.stateSoftConstraintPtr->add("endEffector", std::move(endEffectorIntermediateConstraintPtr_mode0_));
        mpcTimer5_.endTimer();

        mpcTimer6_.startTimer();
        ocp_.finalSoftConstraintPtr->add("finalEndEffector", std::move(endEffectorFinalConstraintPtr_mode0_));
        mpcTimer6_.endTimer();
      ...
      {
        mpcTimer3_.startTimer();
        ocp_.costPtr->add("inputCost", std::move(quadraticInputCostPtr_mode1_));
        mpcTimer3_.endTimer();

        mpcTimer4_.startTimer();
        ocp_.softConstraintPtr->add("jointLimits", std::move(jointLimitSoftConstraintPtr_mode1_));
        mpcTimer4_.endTimer();

        mpcTimer5_.startTimer();
        ocp_.stateSoftConstraintPtr->add("endEffector", std::move(endEffectorIntermediateConstraintPtr_mode1_));
        mpcTimer5_.endTimer();

        mpcTimer6_.startTimer();
        ocp_.finalSoftConstraintPtr->add("finalEndEffector", std::move(endEffectorFinalConstraintPtr_mode1_));
        mpcTimer6_.endTimer();

        mpcTimer7_.startTimer();
        if (activateSelfCollision_)
        {
          ocp_.stateSoftConstraintPtr->add("selfCollision", std::move(selfCollisionConstraintPtr_mode1_));
        }
        mpcTimer7_.endTimer();
      ...
      {
        mpcTimer3_.startTimer();
        ocp_.costPtr->add("inputCost", std::move(quadraticInputCostPtr_mode2_));
        mpcTimer3_.endTimer();

        mpcTimer4_.startTimer();
        ocp_.softConstraintPtr->add("jointLimits", std::move(jointLimitSoftConstraintPtr_mode2_));
        mpcTimer4_.endTimer();

        mpcTimer5_.startTimer();
        ocp_.stateSoftConstraintPtr->add("endEffector", std::move(endEffectorIntermediateConstraintPtr_mode2_));
        mpcTimer5_.endTimer();

        mpcTimer6_.startTimer();
        ocp_.finalSoftConstraintPtr->add("finalEndEffector", std::move(endEffectorFinalConstraintPtr_mode2_));
        mpcTimer6_.endTimer();

        mpcTimer7_.startTimer();
        if (activateSelfCollision_)
        {
          ocp_.stateSoftConstraintPtr->add("selfCollision", std::move(selfCollisionConstraintPtr_mode2_));
        }
        mpcTimer7_.endTimer();
      ...
      std::cout << "\n###   Latest  : " << mpcTimer11_.getLastIntervalInMilliseconds() << "[ms]." << std::endl
                << std::endl;
    ...
    */
    ...
    std::unique_ptr<StateInputCost> MobileManipulatorInterface::getQuadraticInputCost()
    {
      ...
      return std::make_unique<QuadraticInputCost>(std::move(R), modeStateDim);
    }
